...
public:
    ...
    static bool is_pcode_entry(const std::string& entry_name);
    static bool is_pcode_entry(const std::wstring& entry_name);
...
private:
    ...
    template <class Str> static bool is_pcode_entry_impl(const Str& entry_name);
