...
public:
   ...
   virtual PBLMI_Result CreateExeLibrary(const char *szExe, int aPbVer = 6) = 0;
   ...
   virtual IPBLMI_PBL* OpenLibrary(const wchar_t *szLib, BOOL bReadWrite = FALSE) = 0;
...
public:
    ...
    virtual DWORD getStartOffset() = 0;
